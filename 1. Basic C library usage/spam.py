...
_operator_functype = ctypes.CFUNCTYPE(ctypes.c_int, ctypes.c_int, ctypes.c_int)

# Signature of spam.do_operation
_spam.do_operation.argtypes = [ctypes.c_int, ctypes.c_int, _operator_functype]
...
def do_operation(x, y, operator):
    return _spam.do_operation(x, y, _operator_functype(operator))